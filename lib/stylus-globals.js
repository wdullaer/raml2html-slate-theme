 ...
 * @param  {boolean} allcommands     Whterh or not to return all curl commands, or just the first
 * @return {string}                  A example curl statement that calls the API
 */
function getCurlStatement (securitySchemes, baseUri, method, resource, allCommands = false) {
  baseUri = baseUri || ''
